...
import com.maryya.ingredible.ui.components.ScreenWithListsDrawer
import com.maryya.ingredible.viewmodel.shared.SharedViewModel
import com.maryya.ingredible.viewmodel.shared.SharedViewModelFactory
...
@ExperimentalCamera2Interop class MainActivity : ComponentActivity() {
    ...
    fun MainScreen(navController: NavController, viewModel: SharedViewModel) {
        ...
        ScreenWithListsDrawer(navController = navController, viewModel = viewModel) {
